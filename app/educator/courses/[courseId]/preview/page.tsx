  ...
  return (
    <div className="grid gap-5">
      <section className="mx-auto mt-4 flex w-[min(1180px,calc(100%-32px))] flex-wrap items-center justify-between gap-3 rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3 shadow-sm">
        ...
        <Link href={`/educator/courses/${course.id}`} className="rounded-xl border border-blue-200 bg-white px-4 py-2 text-sm font-black text-[var(--brand)] transition hover:border-blue-300 hover:bg-blue-50">
          Back to editor
        </Link>
      </section>
