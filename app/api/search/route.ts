...
function pageKeywords(id: string, locale: Locale) {
  const keywords: Record<Locale, Record<string, string[]>> = {
    ...
    ps: {
      ...
      contact: ["اړیکه", "ایمیل", "پیغام", "ملاتړ ته پیغام"],
